package com.learn.framework.util;
 ...
 * @Description: com.itheima.framework.util.ParseXmlForBean
 ****/
public class XmlBean {
    ...
    public static Map<String,Object> initBeans(){
        ...
        //value=com.itheima.controller.AccountController.newInstance()
        ...
        try {
            ...
            while (size>0){
                ...
                for (MapNode mapNode : mapNodeList) {
                    ...
                    if(o!=null){
                        // 所有属性都注入了
                        boolean allPropertySetted = true;
                        for (Map.Entry<String, String> entry : mapNode.getPropertyMap().entrySet()) {
                            ...
                            if(refo!=null){
                                ...
                                allPropertySetted = false;
                                break;
                            }
                        }
                        if (allPropertySetted) {
